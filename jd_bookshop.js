...
[task_local]
#口袋书店
1 8,12,18 * * * https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_bookshop.js, tag=口袋书店, img-url=https://raw.GIT_HUBusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "1 8,12,18 * * *" script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_bookshop.js,tag=口袋书店

===============Surge=================
口袋书店 = type=cron,cronexp="1 8,12,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_bookshop.js

============小火箭=========
口袋书店 = type=cron,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_bookshop.js, cronexpr="1 8,12,18* * *", timeout=3600, enable=true
 */
const $ = new Env('口袋书店');
