...
[task_local]
#京喜工厂
10 * * * * https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_dreamFactory.js, tag=京喜工厂, img-url=https://GITHUBA.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_dreamFactory.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_dreamFactory.js, cronexpr="10 * * * *", timeout=3600, enable=true
...
function updateTuanIds(url = 'https://raw.GITHUBAusercontent.com/LXK9301/updateTeam/master/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
