...
******************************************************************************
 ...
 iOS可使用BoxJs可使用此订阅修改复制所需的环境变量 https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/mySelf.boxjs.json
 环境变量与BoxJs里面对应关系
 ...
 *****************************************************************************************************************
ziye
本人GITHUBAA地址     https://GITHUBAA.com/ziye12/JavaScript
转载请备注个名字，谢谢
...
############## 圈x
#企鹅读书获取更新body
https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track url script-request-body https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js
#企鹅读书获取时长cookie
https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid? url script-request-header https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js
############## loon
#企鹅读书获取更新body
http-request https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track script-path=https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js,requires-body=true, tag=企鹅读书获取更新body
#企鹅读书获取时长cookie
http-request https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid? script-path=https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js, requires-header=true, tag=企鹅读书获取时长cookie
############## surge
#企鹅读书获取更新body
企鹅读书获取更新body = type=http-request,pattern=https:\/\/mqqapi\.reader\.qq\.com\/log\/v4\/mqq\/track,requires-body=1,max-size=0,script-path=https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js, script-update-interval=0
#企鹅读书获取时长cookie
企鹅读书获取时长cookie = type=http-request,pattern=https:\/\/mqqapi\.reader\.qq\.com\/mqq\/addReadTimeWithBid?,script-path=https://raw.GITHUBAAusercontent.com/LXK9301/jd_scripts/master/backUp/qqread.js
