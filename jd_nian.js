...
[task_local]
#京东炸年兽🧨
0 9,12,20 * * * https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_nian.js, tag=京东炸年兽🧨, img-url=https://raw.GIT_HUBusercontent.com/yogayyy/Scripts/main/Icon/lxk0301/jd_nian.png, enabled=true

================Loon==============
[Script]
cron "0 9,12,20 * * *" script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_nian.js,tag=京东炸年兽🧨

===============Surge=================
京东炸年兽🧨 = type=cron,cronexp="0 9,12,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_nian.js

============小火箭=========
京东炸年兽🧨 = type=cron,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_nian.js, cronexpr="0 9,12,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东炸年兽🧨');
