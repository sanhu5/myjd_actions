...
#圈x
[rewrite local]
https://api3-normal-c-\w+.huoshan.com/hotsoon/flame/task_done/? url script-request-body https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/huoshan.js
#loon
http-request https://api3-normal-c-\w+.huoshan.com/hotsoon/flame/task_done/? script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/huoshan.js, requires-body=true, timeout=10, tag=抖音火山版
#surge
抖音火山版 = type=http-request,pattern=^https://api3-normal-c-\w+.huoshan.com/hotsoon/flame/task_done/?,requires-body=1,max-size=0,script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/huoshan.js,script-update-interval=0
*/
const zhiyi = '抖音火山版'
const $ = Env(zhiyi)
