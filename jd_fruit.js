/*
东东水果:脚本更新地址 https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_fruit.js
更新时间：2021-1-9
...
[task_local]
#jd免费水果
5 6-18/6 * * * https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_fruit.js, tag=东东农场, img-url=https://raw.GITHUBAusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
...
async function doFriendsWater() {
  ...
  if (waterFriendCountKey < waterFriendMax) {
    ...
    if ($.friendList.friends && $.friendList.friends.length > 0) {
      ...
      //TODO ,发现bug,GITHUBA action运行发现有些账号第一次没有给3个好友浇水
