/*
京东天天加速链接：https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_speed.js
更新时间：2020-12-25
支持京东双账号
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
每天4京豆，再小的苍蝇也是肉
从 https://GITHUBA.com/Zero-S1/JD_tools/blob/master/JD_speed.py 改写来的
建议3小时运行一次，打卡时间间隔是6小时
=================QuantumultX==============
[task_local]
#天天加速
8 0-23/3 * * * https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_speed.js, tag=京东天天加速, img-url=https://raw.GITHUBAusercontent.com/58xinian/icon/master/jdjs.png, enabled=true

============Loon================
[Script]
cron "8 0-23/3 * * *" script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_speed.js,tag=京东天天加速

===========Surge============
天天加速 = type=cron,cronexp="8 0-23/3 * * *",wake-system=1,timeout=3600,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_speed.js

==============小火箭=============
天天加速 = type=cron,script-path=https://raw.GITHUBAusercontent.com/LXK9301/jd_scripts/master/jd_speed.js, cronexpr="11 0-23/3 * * *", timeout=3600, enable=true
*/
