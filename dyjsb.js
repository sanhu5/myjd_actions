...
GIT_HUB action有问题，看视频金币太少，建议使用代理软件
GIT_HUB：https://GIT_HUB.com/ZhiYi-N/script
boxjs：https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/ZhiYi-N.boxjs.json
转载留个名字，谢谢
邀请码：8025524531
...
#圈x
[rewrite local]
https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/sign_in/detail? url script-request-header https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js

https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/done/read? url script-request-header https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js

https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/walk/step_submit? - script-request-header https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js

#loon
http-request ^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/sign_in/detail? script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版sign

http-request ^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/done/read? script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版read

http-request ^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/walk/step_submit? script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版step

#surge
dyjsbsign = type=http-request,pattern=^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/sign_in/detail?,requires-body=1,max-size=0,script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js,script-update-interval=0

dyjsbread = type=http-request,pattern=^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/done/read?,requires-body=1,max-size=0,script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js,script-update-interval=0

dyjsbstep = type=http-request,pattern=^https://api5-normal-c-\w+.amemv.com/luckycat/aweme/v1/task/walk/step_submit?,requires-body=1,max-size=0,script-path=https://raw.GIT_HUBusercontent.com/ZhiYi-N/Private-Script/master/Scripts/dyjsb.js,script-update-interval=0
