...
[task_local]
#宝洁美发屋
1 8,9 14-31/1 1 * https://raw.GIT_HUBusercontent.com/shylocks/Loon/main/jd_bj.js, tag=宝洁美发屋, img-url=https://raw.GIT_HUBusercontent.com/yogayyy/Scripts/master/Icon/shylocks/jd_bj.jpg, enabled=true

================Loon==============
[Script]
cron "1 8,9 14-31/1 1 *" script-path=https://raw.GIT_HUBusercontent.com/shylocks/Loon/main/jd_bj.js,tag=宝洁美发屋

===============Surge=================
宝洁美发屋 = type=cron,cronexp="1 8,9 14-31/1 1 *",wake-system=1,timeout=200,script-path=https://raw.GIT_HUBusercontent.com/shylocks/Loon/main/jd_bj.js

============小火箭=========
宝洁美发屋 = type=cron,script-path=https://raw.GIT_HUBusercontent.com/shylocks/Loon/main/jd_bj.js, cronexpr="1 8,9 14-31/1 1 *", timeout=200, enable=true
 */
const $ = new Env('宝洁美发屋');
