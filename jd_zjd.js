 ...
 * @LastEditTime: 2020-12-12 01:32:43
  ...
  quanx:
  [task_local]
  30 18 * * * https://raw.GIT_HUBusercontent.com/whyour/hundun/master/quanx/jd_zjd.js, tag=半自动领京豆, img-url=https://raw.GIT_HUBusercontent.com/58xinian/icon/master/jd_syj.png, enabled=true

  loon:
  [Script]
  cron "30 18 * * *" script-path=https://raw.GIT_HUBusercontent.com/whyour/hundun/master/quanx/jd_zjd.js, tag=半自动领京豆

  surge:
  [Script]
  半自动领京豆 = type=cron,cronexp=30 18 * * *,timeout=60,script-path=https://raw.GIT_HUBusercontent.com/whyour/hundun/master/quanx/jd_zjd.js,
 *
 *
 **/
const $ = new Env("京东赚京豆");
