...
[task_local]
#签到领现金
2 0 * * * https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_cash.js, tag=签到领现金, img-url=https://raw.GIT_HUBusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "2 0 * * *" script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path=https://raw.GIT_HUBusercontent.com/LXK9301/jd_scripts/master/jd_cash.js, cronexpr="2 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('签到领现金');
