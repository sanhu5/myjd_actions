...
[task_local]
#东东爱消除
0 * * * * https://raw.GITHUBAusercontent.com/shylocks/Loon/main/jd_xxl.js, tag=东东爱消除, img-url=https://raw.GITHUBAusercontent.com/yogayyy/Scripts/master/Icon/shylocks/jd_xxl.jpg, enabled=true

================Loon==============
[Script]
cron "0 * * * *" script-path=https://raw.GITHUBAusercontent.com/shylocks/Loon/main/jd_xxl.js,tag=东东爱消除

===============Surge=================
东东爱消除 = type=cron,cronexp="0 * * * *",wake-system=1,timeout=20,script-path=https://raw.GITHUBAusercontent.com/shylocks/Loon/main/jd_xxl.js

============小火箭=========
东东爱消除 = type=cron,script-path=https://raw.GITHUBAusercontent.com/shylocks/Loon/main/jd_xxl.js, cronexpr="0 * * * *", timeout=200, enable=true
 */
const $ = new Env('东东爱消除');
...
if ($.isNode()) {
  ...
  if(JSON.stringify(process.env).indexOf('GITHUBA123')>-1) process.exit(0)
} else {
