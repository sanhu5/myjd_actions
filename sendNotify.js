/*
 * @Author: lxk0301 https://GIT_HUB.com/lxk0301
...
// =======================================微信server酱通知设置区域===========================================
//此处填你申请的SCKEY.
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入PUSH_KEY)
let SCKEY = '';


// =======================================QQ酷推通知设置区域===========================================
//此处填你申请的SKEY(具体详见文档 https://cp.xuthus.cc/)
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入QQ_SKEY)
let QQ_SKEY = '';
...
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面（Name输入BARK_PUSH）
let BARK_PUSH = '';
//BARK app推送铃声,铃声列表去APP查看复制填写
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面（Name输入BARK_SOUND , Value输入app提供的铃声名称，例如:birdsong）
let BARK_SOUND = '';


// =======================================telegram机器人通知设置区域===========================================
//此处填你telegram bot 的Token，例如：1077xxx4424:AAFjv0FcqxxxxxxgEMGfi22B4yh15R5uw
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入TG_BOT_TOKEN)
let TG_BOT_TOKEN = '';
//此处填你接收通知消息的telegram用户的id，例如：129xxx206
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入TG_USER_ID)
let TG_USER_ID = '';

// =======================================钉钉机器人通知设置区域===========================================
//此处填你钉钉 bot 的webhook，例如：5a544165465465645d0f31dca676e7bd07415asdasd
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入DD_BOT_TOKEN)
let DD_BOT_TOKEN = '';
...
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入QYWX_KEY)
let QYWX_KEY = '';
...
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面(Name输入QYWX_AM)
let QYWX_AM = '';

// =======================================iGot聚合推送通知设置区域===========================================
//此处填您iGot的信息(推送key，例如：https://push.hellyw.com/XXXXXXXX)
//注：此处设置GIT_HUB action用户填写到Settings-Secrets里面（Name输入IGOT_PUSH_KEY）
let IGOT_PUSH_KEY = '';
