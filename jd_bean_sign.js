...
京豆签到,自用,可N个京东账号
Node.JS专用
IOS软件用户请使用 https://raw.GITHUBAusercontent.com/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js
更新时间：2021-1-19
Modified From GITHUBA https://GITHUBA.com/ruicky/jd_sign_bot
 */
const $ = new Env('京豆签到');
...
async function downFile () {
  ...
  //   url = 'https://raw.GITHUBAusercontent.com/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js';
  // } else {
  //   url = 'https://cdn.jsdelivr.net/gh/NobyDa/Script@master/JD-DailyBonus/JD_DailyBonus.js';
  // }
  await downloadUrl();
...
function downloadUrl(url = 'https://raw.GITHUBAusercontent.com/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js') {
